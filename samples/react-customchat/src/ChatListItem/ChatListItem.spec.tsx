...
import { ChatListItem } from '../../../../packages/mgt-chat/src/components/ChatListItem/ChatListItem';
...
test.describe('ChatListItem', () => {
  ...
  test('oneonone: self chat', async ({ mount }) => {
    ...
    await expect(component).toContainText('Note to self',{ timeout: 60000 });
  });
  ...
  test('groupchat: Other persons message', async ({ mount }) => {
    ...
    await expect(component).toContainText('Matthew: Hi everyone, call me Matt.',{ timeout: 60000 });
  });
